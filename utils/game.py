...
class Board(self,players,turn_count,active_cards,history_cards):
    def __init__
    self.players=Player
    self.turn_count=
    self.active_cards= """last card played by the player"""
    self.history_cards= """all the cards played from the beginning with the exception of active cards"""
